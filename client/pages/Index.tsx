            ...
            {[
              ...
              <Reveal key={card.title}>
                <TiltCard className="group rounded-xl border bg-card p-6 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
                  ...
                  <h3 className="text-lg font-semibold group-hover:text-primary">{card.title}</h3>
        ...
        <div className="container">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {[
              ...
              <Reveal key={c.title}>
                <Link to="/projects" className="group rounded-xl border bg-card p-6 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
