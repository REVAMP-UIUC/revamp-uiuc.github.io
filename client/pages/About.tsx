    ...
    <div className="space-y-0">
        ...
        <div className="container py-16 md:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            <TerminalHeading
              label="revamp/about"
              text="About Revamp"
              subtext="We’re a six‑person UIUC club collaborating with companies on agentic AI and modern tech. Our members span Computer Science, Statistics, Information Sciences (Data Science), Finance (Data Science), Physics, and Systems Engineering."
              align="center"
            />
          </Reveal>
        </div>
      ...
      <section className="py-12 md:py-16">
        <div className="container space-y-8">
          <Reveal>
            <TerminalHeading
              label="revamp/disciplines"
              text="What we study"
              subtext="Each discipline adds a perspective—autonomy, analytics, and systems reliability—all blending into futuristic, high-signal builds."
            />
          </Reveal>
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {disciplines.map((d) => (
              <Reveal key={d.title}>
                <TiltCard className="glitch-card rounded-2xl border border-border/60 bg-card/70 p-6 shadow-lg transition hover:-translate-y-1">
        ...
        <div className="container space-y-10">
          <Reveal className="text-center">
            <TerminalHeading
              label="revamp/team"
              text="Team Members"
              subtext="Profiles for six members. Replace with your details anytime."
              align="center"
            />
          </Reveal>
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {members.map((p) => (
              <Reveal key={p.role}>
                <TiltCard className="group rounded-2xl border border-border/60 bg-card/80 p-8 text-center shadow-xl transition hover:-translate-y-1">
                  ...
                  <div className="mt-5">
                    <a
                      href={p.linkedin}
                      className="inline-flex items-center gap-2 rounded-md border border-border/60 px-3 py-1.5 text-sm font-mono uppercase tracking-[0.3em] hover:border-primary"
                      target="_blank"
                      rel="noreferrer"
                    >
        ...
        <div className="container">
          <Reveal className="rounded-2xl border border-border/60 bg-card/70 p-8 text-center shadow-xl">
            <TerminalHeading
              ...
              subtext="Reach out or apply to join. We collaborate with teams to deliver agentic AI and cloud solutions."
              align="center"
            />
          </Reveal>
        </div>
