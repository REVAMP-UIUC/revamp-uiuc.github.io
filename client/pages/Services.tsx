...
const services = [
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" className="h-6 w-6 text-[hsl(19,100%,50%)]" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container py-16 md:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight">Our Services</h1>
            <p className="mt-4 text-muted-foreground">
              We partner with teams to architect, build, and ship agentic AI systems and cloud-backed products.
            </p>
          </Reveal>
        </div>
      </section>
      ...
      <section className="py-12 md:py-16">
        <div className="container">
          <Reveal className="rounded-xl border bg-secondary/30 p-6 text-center">
            <h2 className="text-xl md:text-2xl font-semibold">Have a problem to solve?</h2>
            <p className="mt-2 text-muted-foreground">
              Tell us your goals and constraints—we’ll propose a pragmatic plan to reach production.
            </p>
          </Reveal>
        </div>
      </section>
